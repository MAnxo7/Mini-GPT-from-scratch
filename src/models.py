...
class mini_GPT(torch.nn.Module):
    def __init__(self, dropout = 0.1, d_model = 256, n_layers = 6, n_heads = 8, context_L = 256, d_ff = None):
        """
        ...
        self.VOCAB = 256 # vocab_size must be 256 in byte-level tokenization
